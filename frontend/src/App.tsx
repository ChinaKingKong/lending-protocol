      ...
      <section className="relative pt-16 pb-12 px-6">
        <div className="container mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6 backdrop-blur-sm">
            ...
            <span className="text-white/70 text-sm">Powered by Hardhat</span>
          </div>

          {/* Title */}
          <h1 className="text-5xl md:text-7xl font-bold mb-4">
            <span className="gradient-text">DeFi Lending Protocol</span>
          </h1>

          <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
            Supply assets and earn competitive interest rates. Borrow against your collateral with up to 75% LTV.
          </p>
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <div className="glass-card px-6 py-3 flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-white/50 text-xs">Supply APY</p>
              ...
              <div className="glass-card px-6 py-3 flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-white/50 text-xs">Borrow APY</p>
              ...
              <div className="glass-card px-6 py-3 flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-white/50 text-xs">Collateral</p>
            ...
            <div className="glass-card text-center py-12 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-white/50 max-w-md mx-auto">
                  Connect your MetaMask wallet to start using the lending protocol
                </p>
              </div>
            </div>
          )}
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="glass-card group">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h4 className="font-semibold text-white">Supply & Earn</h4>
                  </div>
                  <p className="text-white/50 text-sm">
                    Deposit USD8 tokens as collateral and earn interest based on market utilization rates.
                  </p>
                </div>
                ...
                <div className="glass-card group">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h4 className="font-semibold text-white">Borrow Instantly</h4>
                  </div>
                  <p className="text-white/50 text-sm">
                    Borrow USD8 against your supplied collateral with no credit checks, up to 75% LTV.
                  </p>
                </div>
                ...
                <div className="glass-card group">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h4 className="font-semibold text-white">Flexible Repayment</h4>
                  </div>
                  <p className="text-white/50 text-sm">
                    Repay your borrowed amount at any time to improve your health factor and reduce interest.
                  </p>
                </div>
              </div>
              ...
              <div className="glass-card">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">Health Factor Safety</h4>
                    <p className="text-white/50 text-xs">
                      Position safety indicator based on your collateral vs borrowed amount
                    </p>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-white/70">Safe: HF &gt; 150%</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <span className="w-2 h-2 rounded-full bg-yellow-500"></span>
                    <span className="text-white/70">Moderate: 100% &lt; HF &le; 150%</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <span className="w-2 h-2 rounded-full bg-red-500"></span>
                    <span className="text-white/70">Risk: HF &lt; 100%</span>
                  </div>
                </div>
              </div>
            </>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-white font-semibold">Lending Protocol</p>
                <p className="text-white/40 text-xs">PQA Labs Coding Test</p>
              </div>
            </div>
