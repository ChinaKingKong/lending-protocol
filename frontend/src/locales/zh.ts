...
export const zh: Record<LocaleKey, string> = {
  ...
  "position.healthFactorInfinite": "无穷",
  ...
  "supply.localNetwork": "本地网络 - 请查看 Hardhat 控制台",
  ...
  "withdraw.localNetwork": "本地网络 - 请查看 Hardhat 控制台",
  ...
  "borrow.localNetwork": "本地网络 - 请查看 Hardhat 控制台",
  ...
  "repay.yourDebt": "您的借款",
  "repay.balance": "余额",
  "repay.approveUsd8": "授权 USD8",
  "repay.approving": "授权中...",
  "repay.repay": "偿还",
  "repay.repayAmount": "偿还 {{amount}} USD8",
  "repay.repaying": "偿还中...",
  "repay.errorApproval": "授权失败",
  "repay.repayTip": "偿还可降低债务并改善健康因子",
  "repay.txSubmitted": "交易已提交",
  "repay.localNetwork": "本地网络 - 请查看 Hardhat 控制台",
  ...
  // Block Explorer
  "header.blockExplorer": "区块浏览器",
  "explorer.title": "本地区块浏览器",
  "explorer.connectFirst": "请先连接钱包以查看区块",
  "explorer.backToList": "返回区块列表",
  "explorer.loading": "加载中...",
  "explorer.noBlocks": "暂无区块",
  "explorer.block": "区块",
  "explorer.blockNumber": "区块高度",
  "explorer.blockHash": "区块哈希",
  "explorer.timestamp": "时间戳",
  "explorer.txCount": "交易数",
  "explorer.gasUsed": "Gas 使用",
  "explorer.transactions": "交易列表",
  "explorer.noTransactions": "暂无交易",
  "explorer.transaction": "交易详情",
  "explorer.txHash": "交易哈希",
  "explorer.from": "发送方",
  "explorer.to": "接收方",
  "explorer.value": "金额",
  "explorer.status": "状态",
